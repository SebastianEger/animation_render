...
class Plane(BlenderObject):
    ...
    def _uv(self):
        ...
        bm.faces[0].loops[0][uv_layer].uv = (1, 0)
        bm.faces[0].loops[1][uv_layer].uv = (1, 1)
        bm.faces[0].loops[2][uv_layer].uv = (0, 1)
        bm.faces[0].loops[3][uv_layer].uv = (0, 0)
